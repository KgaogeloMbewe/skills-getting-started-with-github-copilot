...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and water safety sessions at the pool",
    ...
    "Drama Society": {
        "description": "Develop acting skills and put on school theatre productions",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["lena@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Prepare for math competitions with advanced problem solving",
        "schedule": "Mondays, Thursdays, 3:30 PM - 4:30 PM",
        "max_participants": 14,
        "participants": ["sara@mergington.edu", "omar@mergington.edu"]
    },
    "Science Lab": {
